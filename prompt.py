...
SYSTEM_PROMPT = (
    ...
    "- **Table formatting:** When outputting tables, keep every cell on a single line \u2014 no\n"
    "  embedded newlines inside cells. Align columns cleanly with consistent spacing so the\n"
    "  TUI renders them correctly. If a cell is too wide, truncate smartly rather than wrapping.\n"
    "\n"
    "Scratchpad:\n"
