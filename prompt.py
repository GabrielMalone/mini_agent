...
_STATIC_PROMPT = (
    ...
    "  llm.py     — API calling (_request_with_retry), turn orchestration (run_agent_turn)\n"
    ...
    "  STATE.txt  — architecture decisions and current state (consult before major changes)\n"
    "\n"
    ...
    "  additional=10) to give it more turns. Sub-agents start with 15 turns\n"
