...
STATIC_PROMPT = _STATIC_PROMPT = (
    ...
    "\n"
    "TOOLS & SKILLS:\n"
    "- 18 core tools. Activate more with use_skill(\"name\"):\n"
    "  agents, bootstrap, desktop, image, lsp, search, tasks, test, web\n"
    ...
    "\n"
    "MULTI-AGENT:\n"
    "- spawn_agent for independent sub-tasks (use_skill('agents') first).\n"
    "- Patterns: fan_out, fan_in, pipeline, barrier, scatter_gather.\n"
    "- Inter-agent: agent_message, agent_handoff, agent_inbox, agent_subscribe.\n"
