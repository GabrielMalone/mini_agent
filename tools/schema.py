...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "collect_agent",
            "description": "Block until a sub-agent completes (or times out at 120s), then return its full result. Use this when you're ready to consume the sub-agent's output.",
            "parameters": {
                "type": "object",
                "properties": {
                    "task_id": {
